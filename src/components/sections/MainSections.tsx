        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Тихий Океан Протэк — ваш технический партнер для мероприятий любого масштаба. Мы предоставляем полный спектр услуг: от аренды современного оборудования до комплексного технического обеспечения с профессиональной командой специалистов.
            </p>
          </div>
